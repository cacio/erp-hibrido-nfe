...
class FinTitulo
{
    ...
    #[ORM\ManyToOne(targetEntity: FinPlano::class)]
    #[ORM\JoinColumn(name: 'plano_id', referencedColumnName: 'id', nullable: false)]
    private FinPlano $plano;
    ...
    public function getPlano(): ?FinPlano
    {
        return $this->plano;
    }
