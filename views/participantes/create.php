...
<div class="top-bar-header">
    ...
    <div class="top-bar-actions">
        <button type="submit" form="main-form" id="btn-submit" class="btn btn-primary">
            <span class="btn-text">Salvar Cadastro</span>
        </button>
    </div>
</div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 2fr 2fr; gap: 15px;">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" class="form-control" name="cpf_cnpj" id="cpf_cnpj" required placeholder="Somente números" maxlength="18">
