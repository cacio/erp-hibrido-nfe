        ...
        <main class="main-content">
            <header class="top-bar">
                <div class="top-bar-header">
                    ...
                    <h2><?= $titletopbar ?></h2>
                    <span class="version-badge" onclick="abrirJanelaUnica('Log de mudanças','Log de mudanças', '/changelog?winbox=1')" style="cursor: pointer; font-size: 10px; background: rgba(79, 70, 229, 0.1); color: var(--primary-color); padding: 2px 8px; border-radius: 20px; vertical-align: middle; margin-left: 10px; border: 1px solid rgba(79, 70, 229, 0.2);"><?= APP_VERSION ?></span>
                </div>
            ...
            <?= $content ?>
            <!-- WinBox Taskbar -->
            <div class="winbox-taskbar" id="winbox-taskbar" style="display: none;">
                <!-- Itens da taskbar serão inseridos aqui via JS -->
            </div>
        </main>
